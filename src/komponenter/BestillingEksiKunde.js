...
import { ansatteService,kundeService,bestillingService } from '../services/services';
...
export class BestillingSkjema extends Component {
  ...
  render() {
    ...
    return(
      ...
      <div className="col">
        ...
        <div className="row-sm-10">
          <div className="form-check">
            ...
            <label htmlFor="terreng" className="form-check-label">Terrengsykkel</label>
          ...
          <div className="form-check">
            ...
            <label htmlFor="tandem" className="form-check-label">Tandemsykkel</label>
          ...
          <div className="form-check">
            ...
            <label htmlFor="el" className="form-check-label">Elsykkel</label>
      ...
      <div className="col">
        ...
        <div className="row-sm-10">
          <div className="form-group">
            <Form.Label htmlFor="fra">Fra:</Form.Label>
            ...
            <Form.Label htmlFor="til">Til:</Form.Label>
      ...
      <div className="col">
        ...
        <div className="row-sm-10">
          <div className="form-group">
            <Form.Label htmlFor="henteTid">Fra:</Form.Label>
            ...
            <Form.Label htmlFor="levereTid">Til:</Form.Label>
      ...
      <div className="col">
        ...
        <div className="row-sm-10">
          <div className="form-group">
          {/*Lager select med mulige hentesteder og leveringssteder*/}
            <Form.Label htmlFor="hente">Hentested:</Form.Label>
            ...
            <Form.Label htmlFor="levere">Leveringssted:</Form.Label>
      ...
      <div className="form-group row">
        ...
        <div className="col-sm-10">
          <div className="form-check">
            <label htmlFor="hjelm" className="form-check-label">
              Antall
            </label>
            <input className="form-control form-control-sm" style={{width: 8 + 'em'}} type="number" id="hjelm" placeholder='0' min='0' onChange={e => e.target.value<0 ? e.target.value = 0 : e.target.value = e.target.value}/>
      ...
      <div className="form-group row">
        ...
        <div className="col-sm-10">
          <div className="form-check">
            <label htmlFor="barnevogn" className="form-check-label">
              Antall
            </label>
            <input className="form-control form-control-sm" style={{width: 8 + 'em'}} type="number" placeholder='0' id="barnevogn" min='0' onChange={e => e.target.value<0 ? e.target.value = 0 : e.target.value = e.target.value} />
        ...
        <div className="col-sm-10">
          <div className="form-check">
            <label htmlFor="barnesete" className="form-check-label">
              Antall
            </label>
            <input className="form-control form-control-sm" style={{width: 8 + 'em'}} type="number" placeholder='0' id="barnesete" min='0' onChange={e => e.target.value<0 ? e.target.value = 0 : e.target.value = e.target.value} />
  ...
  mounted() {
    ...
    this.mm = ("0" + (this.fraDato.getMonth()+1)).slice(-2);
  ...
  render() {
    ...
    return(
      <div>
        ...
        <p>Kunde: {this.bestilling.fornavn} {this.bestilling.etternavn}</p>
        <p>Antall personer: {this.bestilling.personer}</p>
        <div className="row">
        ...
        <div className="row">
          <div className="col-2">
            ...
            <p>Hentested: {this.bestilling.lager}</p>
          </div>
          <div className="col-2">
            <h6>Levere</h6>
            <p>Dato: {this.bestilling.slutt.toLocaleDateString()}</p>
        ...
        <NavLink to="/regB">Tilbake</NavLink>
        </Card>
      </div>
    )
  }
